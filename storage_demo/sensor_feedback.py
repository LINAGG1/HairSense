...
FACTS = {
    "optical_high": "이번 측정의 일부 구간에서 두피 유분이 평소 기준보다 많게 나타났어요.",
    "optical_low": "이번 측정의 일부 구간에서 두피 유분이 평소 기준보다 적게 나타났어요.",
    "optical_mixed": "이번 측정에서 두피 유분이 평소 기준보다 높은 구간과 낮은 구간이 함께 나타났어요.",
    "optical_pattern": "이번 측정의 일부 구간에서 평소와 다른 유분 분포가 나타났어요.",
    "optical_unflagged": "이번 측정에서는 설정된 기준을 넘는 두피 유분 구간이 표시되지 않았어요.",
    "gyro_rapid": "이번 일부 구간에서 평소 기준보다 급격한 움직임 변화 횟수가 측정되었어요.",
    "gyro_pattern": "이번 측정의 일부 구간에서 평소 기준과 다른 움직임 패턴이 표시되었어요.",
    "gyro_unflagged": "이번 측정에서는 설정된 기준을 넘는 움직임 구간이 표시되지 않았어요.",
}
DEFAULT_TIPS = {
    "optical": "유분이 많은 날에는 두피에 잔여물이 남지 않도록 꼼꼼히 세정해 보세요.",
